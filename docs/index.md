...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: 查看演示
      link: https://uglyp.github.io/q-uniapp-demo/#/

features:
  - icon: ⚡️
    title: Vue3 + Vite4 + Pnpm 
    details: Vue3 + Vite4 + Pnpm 最强组合，快速打包，快速构建，快速热更新。
    linkText: 进入 Vue 官网
  ...
  - icon: 🦾
    ...
    link: https://github.com/uglyp/q-uniapp
